...
PCL>=1.6, Follow [PCL Installation](https://pointclouds.org/). 1.14.0

Eigen>=3.3.4, Follow [Eigen Installation](https://eigen.tuxfamily.org/index.php?title=Main_Page). 3.4.0

OpenCV>=3.2, Follow [Opencv Installation](http://opencv.org/). 4.2
...
# in CMakeLists of vikit_common add
...
topics:      /left_camera/image    1187 msgs    : sensor_msgs/Image         
             /livox/imu           23988 msgs    : sensor_msgs/Imu           
             /livox/lidar          1187 msgs    : livox_ros_driver/CustomMsg
